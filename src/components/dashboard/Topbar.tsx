...
export function Topbar({ greeting, onSettingsOpen, onCategoriseOpen }: TopbarProps) {
  ...
  return (
    <>
      <div style={{ background: 'var(--color-bg)', boxShadow: '0 1px 0 var(--color-border)', padding: '0 20px', height: 'var(--topbar-height)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
